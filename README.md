...
- Sebelum menyentuh UI Flutter, saya memastikan backend dapat menyajikan data. Saya menyesuaikan view show_json di main/views.py dan mengujinya langsung di browser untuk memastikan data JSON muncul.
- Dengan API yang berfungsi, saya beralih ke Flutter. Saya membuat lib/screens/product_entry_list.dart untuk memanggil /json/. Saya membuat lib/widgets/product_entry_card.
...
- Untuk mencoba dan melakukan testing flutter disini, saya mengubah semua url menjadi localhost:8000 untuk testing pada google chrome, lalu untuk commit saya ubah menjadi link PWS yang sebelumnya digunakan.